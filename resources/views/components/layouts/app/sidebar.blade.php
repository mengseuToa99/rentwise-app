        ...
        <flux:sidebar sticky stashable="{{ !($preserveSidebar ?? false) }}" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-black">
            ...
            <div class="mb-4 flex w-full items-center justify-between">
                ...
                <button 
                    x-data="themeToggle()"
                    x-on:click="toggle()" 
                    class="flex h-8 w-8 items-center justify-center rounded-md border border-zinc-200 bg-red-500 text-zinc-700 hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
                >
                    <svg 
