                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-zinc-700">
                            <thead class="bg-gray-50 dark:bg-zinc-800">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Parent Role</th>
                                ...
                                @forelse ($roles as $role)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button wire:click="openEditModal({{ $role->role_id }})" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300 mr-3">Edit</button>
                                            <button wire:click="deleteRole({{ $role->role_id }})" class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300" onclick="confirm('Are you sure you want to delete this role?') || event.stopImmediatePropagation()">Delete</button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        ...
                                        <form wire:submit.prevent="saveRole">
                                            <div class="grid grid-cols-1 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" wire:model="role_name" id="role_name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white rounded-md">
                                                ...
                                                <div>
                                                    ...
                                                    <textarea wire:model="description" id="description" rows="3" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white rounded-md"></textarea>
                                                    @error('description') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                                </div>

                                                <!-- Parent Role -->
                                                <div>
                                                    <label for="parent_role_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Parent Role (Optional)</label>
                                                    <select wire:model="parent_role_id" id="parent_role_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 dark:text-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
