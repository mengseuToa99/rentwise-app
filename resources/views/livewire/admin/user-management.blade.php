                                ...
                                @forelse ($users as $user)
                                    <tr>
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <div class="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center">
                                                        <span class="font-medium text-gray-700">{{ substr($user->first_name, 0, 1) }}{{ substr($user->last_name, 0, 1) }}</span>
                                                    </div>
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button wire:click="openEditModal({{ $user->user_id }})" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</button>
                                            <button wire:click="deleteUser({{ $user->user_id }})" class="text-red-600 hover:text-red-900" onclick="confirm('Are you sure you want to delete this user?') || event.stopImmediatePropagation()">Delete</button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        ...
                                        <form wire:submit.prevent="saveUser">
                                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" wire:model="username" id="username" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                    ...
                                                    <div class="mt-2 space-y-2">
                                                        @foreach ($roles as $role)
                                                            <div class="flex items-center">
                                                                ...
                                                                >
                                                                <label for="role-{{ $role->role_id }}" class="ml-2 text-sm text-gray-700">{{ $role->role_name }}</label>
                                                            </div>
                                                        @endforeach
                                                    </div>
